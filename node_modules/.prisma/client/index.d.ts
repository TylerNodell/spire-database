...
> = S extends true
  ...
  ? 'include' extends U
    ? Unit  & {
      ...
      P extends 'agent'
      ? AgentGetPayload<S['include'][P]> : never
    }
  : 'select' extends U
    ? {
...
: 
      ...
      P extends 'agent'
      ? AgentGetPayload<S['select'][P]> : never
    }
  : Unit
: Unit
...
export declare class Prisma__UnitClient<T> implements Promise<T> {
  ...
  agent<T extends AgentArgs = {}>(args?: Subset<T, AgentArgs>): CheckSelect<T, Prisma__AgentClient<Agent | null>, Prisma__AgentClient<AgentGetPayload<T> | null>>;
...
export type UnitWhereInput = {
  ...
  ownerId?: number | IntFilter
  tenantId?: number | IntFilter
  agentId?: number | IntFilter
  ...
  tenant?: TenantWhereInput | null
  agent?: AgentWhereInput | null
}
...
export type OwnerCreateOneWithoutUnitsInput = {
  create?: OwnerCreateWithoutUnitsInput
  connect?: OwnerWhereUniqueInput
  connectOrCreate?: OwnerCreateOrConnectWithoutUnitInput
}
...
export type TenantCreateOneWithoutUnitInput = {
  create?: TenantCreateWithoutUnitInput
...
export type AgentCreateOneWithoutUnitsInput = {
  create?: AgentCreateWithoutUnitsInput
  connect?: AgentWhereUniqueInput
  connectOrCreate?: AgentCreateOrConnectWithoutUnitInput
}
...
export type UnitCreateWithoutBuildingInput = {
  ...
  apt: string
  sale: boolean
  owner: OwnerCreateOneWithoutUnitsInput
  tenant: TenantCreateOneWithoutUnitInput
  agent: AgentCreateOneWithoutUnitsInput
}
...
export type OwnerUpsertWithoutUnitsInput = {
  update: OwnerUpdateWithoutUnitsDataInput
  create: OwnerCreateWithoutUnitsInput
}

export type OwnerUpdateOneRequiredWithoutUnitsInput = {
  create?: OwnerCreateWithoutUnitsInput
  connect?: OwnerWhereUniqueInput
  update?: OwnerUpdateWithoutUnitsDataInput
  upsert?: OwnerUpsertWithoutUnitsInput
  connectOrCreate?: OwnerCreateOrConnectWithoutUnitInput
}
...
export type TenantUpdateOneRequiredWithoutUnitInput = {
  create?: TenantCreateWithoutUnitInput
  connect?: TenantWhereUniqueInput
  update?: TenantUpdateWithoutUnitDataInput
...
export type AgentUpsertWithoutUnitsInput = {
  update: AgentUpdateWithoutUnitsDataInput
  create: AgentCreateWithoutUnitsInput
}

export type AgentUpdateOneRequiredWithoutUnitsInput = {
  create?: AgentCreateWithoutUnitsInput
  connect?: AgentWhereUniqueInput
  update?: AgentUpdateWithoutUnitsDataInput
  upsert?: AgentUpsertWithoutUnitsInput
  connectOrCreate?: AgentCreateOrConnectWithoutUnitInput
}
...
export type UnitUpdateWithoutBuildingDataInput = {
  ...
  apt?: string
  sale?: boolean
  owner?: OwnerUpdateOneRequiredWithoutUnitsInput
  tenant?: TenantUpdateOneRequiredWithoutUnitInput
  agent?: AgentUpdateOneRequiredWithoutUnitsInput
}
...
export type UnitUpdateOneRequiredWithoutTenantInput = {
  create?: UnitCreateWithoutTenantInput
  connect?: UnitWhereUniqueInput
  update?: UnitUpdateWithoutTenantDataInput
...
export type TenantUpdateInput = {
  ...
  phone?: string | null
  email?: string | null
  unit?: UnitUpdateOneRequiredWithoutTenantInput
}
